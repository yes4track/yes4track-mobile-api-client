...
abstract class GetAllPagedTrackResponse implements Built<GetAllPagedTrackResponse, GetAllPagedTrackResponseBuilder> {
    ...
    static void _defaults(GetAllPagedTrackResponseBuilder b) => b;
...
class _$GetAllPagedTrackResponseSerializer implements StructuredSerializer<GetAllPagedTrackResponse> {
    @override
    final Iterable<Type> types = const [GetAllPagedTrackResponse, _$GetAllPagedTrackResponse];

    @override
    final String wireName = r'GetAllPagedTrackResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllPagedTrackResponse object,
        ...
        if (object.results != null) {
            result
                ...
                ..add(serializers.serialize(object.results,
                    specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllTrackResponse)])));
        }
        return result;
    }

    @override
    GetAllPagedTrackResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = GetAllPagedTrackResponseBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'results':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllTrackResponse)])) as BuiltList<GetAllTrackResponse>?;
