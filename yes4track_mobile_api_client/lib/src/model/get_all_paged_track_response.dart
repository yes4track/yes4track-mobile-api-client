        ...
        if (object.results != null) {
            result
                ...
                ..add(serializers.serialize(object.results,
                    specifiedType: const FullType(BuiltList, [FullType(GetAllTrackResponse)])));
        }
        return result;
    }
            ...
            switch (key) {
                ...
                case r'results':
                    result.results.replace(serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(GetAllTrackResponse)])) as BuiltList<GetAllTrackResponse>);
                    break;
            }
        }
        return result.build();
