...
part of 'post_oauth_sign_in_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PostOauthSignInResponse extends PostOauthSignInResponse {
  @override
  ...
  factory _$PostOauthSignInResponse(
          [void Function(PostOauthSignInResponseBuilder)? updates]) =>
      (new PostOauthSignInResponseBuilder()..update(updates)).build();

  _$PostOauthSignInResponse._(
      {this.tokenType,
      this.accessToken,
      this.refreshToken,
      this.expiresIn,
  ...
  @override
  PostOauthSignInResponse rebuild(
          void Function(PostOauthSignInResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PostOauthSignInResponseBuilder toBuilder() =>
      new PostOauthSignInResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PostOauthSignInResponse &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PostOauthSignInResponse')
...
class PostOauthSignInResponseBuilder
    implements
        Builder<PostOauthSignInResponse, PostOauthSignInResponseBuilder> {
  _$PostOauthSignInResponse? _$v;
  ...
  PostOauthSignInResponseBuilder() {
    PostOauthSignInResponse._initializeBuilder(this);
  }

  PostOauthSignInResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PostOauthSignInResponse other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PostOauthSignInResponse;
  }

  @override
  void update(void Function(PostOauthSignInResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$PostOauthSignInResponse build() {
    _$PostOauthSignInResponse _$result;
    try {
      _$result = _$v ??
          new _$PostOauthSignInResponse._(
              tokenType: tokenType,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'PostOauthSignInResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
