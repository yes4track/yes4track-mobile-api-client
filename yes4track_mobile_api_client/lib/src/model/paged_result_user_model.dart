...
part 'paged_result_user_model.g.dart';

/// PagedResultUserModel
///
/// Properties:
/// * [results] 
/// * [currentPage] 
...
/// * [firstRowOnPage] 
/// * [lastRowOnPage] 
abstract class PagedResultUserModel implements Built<PagedResultUserModel, PagedResultUserModelBuilder> {
    ...
    PagedResultUserModel._();

    static void _initializeBuilder(PagedResultUserModelBuilder b) => b;

    factory PagedResultUserModel([void updates(PagedResultUserModelBuilder b)]) = _$PagedResultUserModel;

    @BuiltValueSerializer(custom: true)
    static Serializer<PagedResultUserModel> get serializer => _$PagedResultUserModelSerializer();
}

class _$PagedResultUserModelSerializer implements StructuredSerializer<PagedResultUserModel> {
    @override
    final Iterable<Type> types = const [PagedResultUserModel, _$PagedResultUserModel];

    @override
    final String wireName = r'PagedResultUserModel';

    @override
    Iterable<Object?> serialize(Serializers serializers, PagedResultUserModel object,
    ...
    @override
    PagedResultUserModel deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PagedResultUserModelBuilder();
