...
abstract class GetAllPagedAdventureResponse implements Built<GetAllPagedAdventureResponse, GetAllPagedAdventureResponseBuilder> {
    ...
    static void _defaults(GetAllPagedAdventureResponseBuilder b) => b;
        ...
        if (object.results != null) {
            result
                ...
                ..add(serializers.serialize(object.results,
                    specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllAdventureResponse)])));
        }
        return result;
    }
    ...
    GetAllPagedAdventureResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'results':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllAdventureResponse)])) as BuiltList<GetAllAdventureResponse>?;
