...
part 'post_oauth_access_token_response.g.dart';
...
/// * [isEmailVerified] 
/// * [idpAccessToken] 
abstract class PostOauthAccessTokenResponse implements Built<PostOauthAccessTokenResponse, PostOauthAccessTokenResponseBuilder> {
    ...
    PostOauthAccessTokenResponse._();

    static void _initializeBuilder(PostOauthAccessTokenResponseBuilder b) => b;

    factory PostOauthAccessTokenResponse([void updates(PostOauthAccessTokenResponseBuilder b)]) = _$PostOauthAccessTokenResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<PostOauthAccessTokenResponse> get serializer => _$PostOauthAccessTokenResponseSerializer();
}

class _$PostOauthAccessTokenResponseSerializer implements StructuredSerializer<PostOauthAccessTokenResponse> {
    @override
    final Iterable<Type> types = const [PostOauthAccessTokenResponse, _$PostOauthAccessTokenResponse];

    @override
    final String wireName = r'PostOauthAccessTokenResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, PostOauthAccessTokenResponse object,
    ...
    @override
    PostOauthAccessTokenResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PostOauthAccessTokenResponseBuilder();
