...
class _$UserManager extends UserManager {
  @override
  final String? id;
  @override
  ...
  factory _$UserManager([void Function(UserManagerBuilder)? updates]) =>
      (new UserManagerBuilder()..update(updates)).build();
  ...
  @override
  UserManager rebuild(void Function(UserManagerBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  UserManagerBuilder toBuilder() => new UserManagerBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UserManager &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('UserManager')
          ..add('id', id)
...
class UserManagerBuilder implements Builder<UserManager, UserManagerBuilder> {
  _$UserManager? _$v;
  ...
  UserManagerBuilder() {
    UserManager._initializeBuilder(this);
  }

  UserManagerBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(UserManager other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$UserManager;
  }

  @override
  void update(void Function(UserManagerBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$UserManager build() {
    _$UserManager _$result;
    try {
      _$result = _$v ??
          new _$UserManager._(
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'UserManager', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
