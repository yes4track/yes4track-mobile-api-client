...
part 'post_oauth_refresh_token_response.g.dart';

/// PostOauthRefreshTokenResponse
///
/// Properties:
/// * [tokenType] 
/// * [accessToken] 
...
/// * [isEmailVerified] 
/// * [idpAccessToken] 
abstract class PostOauthRefreshTokenResponse implements Built<PostOauthRefreshTokenResponse, PostOauthRefreshTokenResponseBuilder> {
    ...
    PostOauthRefreshTokenResponse._();

    static void _initializeBuilder(PostOauthRefreshTokenResponseBuilder b) => b;

    factory PostOauthRefreshTokenResponse([void updates(PostOauthRefreshTokenResponseBuilder b)]) = _$PostOauthRefreshTokenResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<PostOauthRefreshTokenResponse> get serializer => _$PostOauthRefreshTokenResponseSerializer();
}

class _$PostOauthRefreshTokenResponseSerializer implements StructuredSerializer<PostOauthRefreshTokenResponse> {
    @override
    final Iterable<Type> types = const [PostOauthRefreshTokenResponse, _$PostOauthRefreshTokenResponse];

    @override
    final String wireName = r'PostOauthRefreshTokenResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, PostOauthRefreshTokenResponse object,
    ...
    @override
    PostOauthRefreshTokenResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PostOauthRefreshTokenResponseBuilder();
