...
class _$PostUserSetupAngelRequestSerializer implements StructuredSerializer<PostUserSetupAngelRequest> {
    @override
    final Iterable<Type> types = const [PostUserSetupAngelRequest, _$PostUserSetupAngelRequest];

    @override
    final String wireName = r'PostUserSetupAngelRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, PostUserSetupAngelRequest object,
    ...
    @override
    PostUserSetupAngelRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PostUserSetupAngelRequestBuilder();
