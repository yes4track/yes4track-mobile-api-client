...
abstract class PostTrackResponse implements Built<PostTrackResponse, PostTrackResponseBuilder> {
    ...
    static void _defaults(PostTrackResponseBuilder b) => b;
...
class _$PostTrackResponseSerializer implements StructuredSerializer<PostTrackResponse> {
    @override
    final Iterable<Type> types = const [PostTrackResponse, _$PostTrackResponse];

    @override
    final String wireName = r'PostTrackResponse';
    ...
    @override
    PostTrackResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PostTrackResponseBuilder();
