...
class ExperienceApi {
  ...
  Future<Response<GetAllExperienceResponse>> getByIdExperience({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '68e1e357-edcc-437b-a556-e437f8c2d898',
  ...
  Future<Response<GetByIdExperienceCodeResponse>> getByIdExperienceCode({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'bfea903e-6ff3-4234-a016-d9a5cf190b46',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<GetAllPagedExperienceResponse>> yes4trackV1ExperiencesGet({ 
    ...
    String? sort,
    String? xApiKey,
    String? xCsrfToken = '68e2ea3b-1a34-466f-8ac9-5bbb6c2336bf',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1ExperiencesIdActivatePost({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'bb098b11-9ff6-49bc-99b1-58181bc93d69',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<PostCheckExperienceCodeResponse>> yes4trackV1ExperiencesIdCodeCodeCheckPost({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '48fbd897-8cea-4366-bb78-b1d0ae1e580b',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1ExperiencesIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'da5b11eb-2cd8-4633-a16b-22dec913194f',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1ExperiencesIdImagesImageIdDelete({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '9e0ac420-f7d6-4b9d-b64e-b8a0e3e495e4',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<BuiltList<String>>> yes4trackV1ExperiencesIdImagesPost({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'ece1a933-9479-400f-8c78-7e5dc5ebe67c',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1ExperiencesIdPatch({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '006c5d51-3b48-4cbb-a079-c3f8f4fc0dea',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1ExperiencesIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'a1c58e34-51cd-4a1c-b865-cbc3e26cda90',
  ...
  Future<Response<BuiltList<String>>> yes4trackV1ExperiencesIdVideosPost({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'f7a2c32c-7f8a-45d3-a937-473623affda8',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1ExperiencesIdVideosVideoIdDelete({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'fa516985-f29d-4f7a-9a78-0b16076ca0c2',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<PostExperienceResponse>> yes4trackV1ExperiencesPost({ 
    String? xApiKey,
    String? xCsrfToken = 'ca876ca6-10a5-407f-9322-b4b5014f1318',
