...
class TrailApi {
  ...
  Future<Response<GetAllTrailResponse>> getByIdTrail({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'aadce28a-6da3-4861-af31-49ff25715f27',
  ...
  Future<Response<GetByIdTrailGeoDataResponse>> getByIdTrailGeoData({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '8a247c07-1d2a-40b6-a434-a4cd373e959e',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<TrailGeoLocationDto>> getByIdTrailGeoLocation({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'f3952129-2607-4d62-89a7-36b0d38da11a',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<GetAllActiveTrailByAngelResponse>> yes4trackV1TrailsActiveByAngelGet({ 
    String? xApiKey,
    String? xCsrfToken = 'f89810e1-b67b-48ce-93b3-5ff6065cfa16',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1TrailsEndopenPut({ 
    String? xApiKey,
    String? xCsrfToken = '657e4675-1108-4034-912b-e514bdf4689e',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<GetAllPagedTrailResponse>> yes4trackV1TrailsGet({ 
    ...
    String? sort,
    String? xApiKey,
    String? xCsrfToken = 'bcb07299-7f3e-44e5-ac0a-4d69ffa31528',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1TrailsIdAngelAngelIdDelete({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '1b1e7ae7-a2aa-48ce-9d65-4a8dd86a1f10',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1TrailsIdAngelAngelIdPost({ 
    ...
    required String angelId,
    String? xApiKey,
    String? xCsrfToken = '6bdae855-6a53-4aa2-9b4a-a0f9ef35a218',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<PostAdventureResponse>> yes4trackV1TrailsIdCompanyIdTrailtoadventurePost({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '5b02dfe6-e885-4491-90c0-cbc8385ccada',
  ...
  Future<Response<void>> yes4trackV1TrailsIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '931a846f-48d2-49bd-b05d-fb6dbe6f90d6',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1TrailsIdGeodataChunckPost({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'f97375d5-3838-4d42-ad63-3fb9ea4a6272',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<PostTrailGeoDataResponse>> yes4trackV1TrailsIdGeodataPost({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '1115b537-f189-4ebe-b5ac-7ff9080f4fec',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<BuiltList<PostTrailPhotosResponse>>> yes4trackV1TrailsIdImagesPost({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'b4482a00-8ad5-4e86-92df-74a7c18be1ef',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1TrailsIdMapPhotoPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '7a87b763-9a51-45ce-b0c3-f0547480404c',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1TrailsIdPatch({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '62659d93-d7d4-409d-ab37-aa9dbb3f836d',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1TrailsIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'ead94c55-3313-407d-9461-9bf676e2a73b',
  ...
  Future<Response<void>> yes4trackV1TrailsIdSponsorSponsorIdDelete({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'f13d16d6-9e69-4787-94c5-fb32ff7d3f55',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1TrailsIdSponsorSponsorIdPost({ 
    ...
    required String sponsorId,
    String? xApiKey,
    String? xCsrfToken = '665051b3-f778-4503-9684-1cb467661563',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<PostTrailResponse>> yes4trackV1TrailsPost({ 
    String? xApiKey,
    String? xCsrfToken = 'c1afa302-248c-473f-be5d-e5d8682db700',
