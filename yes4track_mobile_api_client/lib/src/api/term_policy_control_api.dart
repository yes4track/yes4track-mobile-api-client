...
class TermPolicyControlApi {

  final Dio _dio;

  final Serializers _serializers;

  const TermPolicyControlApi(this._dio, this._serializers);
  ...
  Future<Response<void>> deleteTermPolicyControl({ 
    required String id,
    ...
    final _path = r'/hypercube_usm/v1/termpolicycontrol/{id}'.replaceAll('{' r'id' '}', id.toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TermPolicyControl] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TermPolicyControl>> termPolicyControlGetById({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    TermPolicyControl _responseData;

    try {
      const _responseType = FullType(TermPolicyControl);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as TermPolicyControl;
    ...
    return Response<TermPolicyControl>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<TermPolicyControl>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<TermPolicyControl>>> termPolicyControlGetFind({ 
    String? title,
    String? type,
    String? content,
    int? version,
    ...
    final _path = r'/hypercube_usm/v1/termpolicycontrol/find';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<TermPolicyControl> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(TermPolicyControl)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<TermPolicyControl>;
    ...
    return Response<BuiltList<TermPolicyControl>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> termPolicyControlPatch({ 
    required String id,
  ...
  /// Returns a [Future] containing a [Response] with a [TermPolicyControl] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TermPolicyControl>> termPolicyControlPost({ 
    TermPolicyControl? model,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/hypercube_usm/v1/termpolicycontrol';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TermPolicyControl);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> termPolicyControlPut({ 
    required String id,
    TermPolicyControl? model,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
