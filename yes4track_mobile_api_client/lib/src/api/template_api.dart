...
class TemplateApi {
  ...
  Future<Response<GetAllTemplateResponse>> getByIdTemplate({ 
    ...
    final _path = r'/yes4track/v1/templates/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    GetAllTemplateResponse _responseData;

    try {
      const _responseType = FullType(GetAllTemplateResponse);
  ...
  Future<Response<GetAllPagedTemplateResponse>> yes4trackV1TemplatesGet({ 
    ...
    final _path = r'/yes4track/v1/templates';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    GetAllPagedTemplateResponse _responseData;

    try {
      const _responseType = FullType(GetAllPagedTemplateResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<BuiltList<String>>> yes4trackV1TemplatesIdPhotosUploadPost({ 
    ...
    final _path = r'/yes4track/v1/templates/{id}/photos/upload'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
  ...
  Future<Response<PostTemplateResponse>> yes4trackV1TemplatesPost({ 
    ...
    PostTemplateResponse _responseData;

    try {
      const _responseType = FullType(PostTemplateResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
