...
class SponsorApi {
  ...
  Future<Response<GetAllSponsorResponse>> getByIdSponsor({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'fcc273c4-5034-48e7-bba6-e79bd194d960',
    ...
    final _path = r'/yes4track/v1/sponsors/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    GetAllSponsorResponse _responseData;

    try {
      const _responseType = FullType(GetAllSponsorResponse);
  ...
  Future<Response<GetAllPagedSponsorResponse>> yes4trackV1SponsorsGet({ 
    ...
    String? sort,
    String? xApiKey,
    String? xCsrfToken = '5ab416ab-e5d4-4a26-b1ed-958f5fa3e84a',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/yes4track/v1/sponsors';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    GetAllPagedSponsorResponse _responseData;

    try {
      const _responseType = FullType(GetAllPagedSponsorResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<void>> yes4trackV1SponsorsIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '1f1bc67e-75ed-421b-96d5-21d84efb59ae',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1SponsorsIdPatch({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '3dcb7b81-24df-4777-aa6f-36a274250517',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1SponsorsIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '19ebd7b0-5f2e-4df9-9762-af72a2648787',
  ...
  Future<Response<PostSponsorResponse>> yes4trackV1SponsorsPost({ 
    String? xApiKey,
    String? xCsrfToken = '97454b61-31e0-4cfe-b7af-3dab62fc1746',
    ...
    PostSponsorResponse _responseData;

    try {
      const _responseType = FullType(PostSponsorResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
