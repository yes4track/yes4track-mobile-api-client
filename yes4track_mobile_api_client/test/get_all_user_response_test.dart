...
// tests for GetAllUserResponse
void main() {
  final instance = GetAllUserResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetAllUserResponse, () {
    // DateTime createdAt
    ...
    // bool isSuperAdmin
    test('to test the property `isSuperAdmin`', () async {
      // TODO
    });

    // bool isAngel
    test('to test the property `isAngel`', () async {
      // TODO
    });
    ...
    test('to test the property `defaultSponsor`', () async {
      // TODO
    });

    // BuiltList<String> companies
    test('to test the property `companies`', () async {
      // TODO
    });
