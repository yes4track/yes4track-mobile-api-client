...
void main() {
  ...
  group(UserApi, () {
    ...
    // User SignIn
    //
    //Future<PostUserAccessTokenResponse> yes4trackV1UsersAccesstokenPost({ String xApiKey, String xCsrfToken, PostUserAccessTokenRequest postUserAccessTokenRequest }) async
    ...
    // Update User Photo
    //
    //Future yes4trackV1UsersIdPhotoPut(String id, { String xApiKey, String xCsrfToken, ProfilePhotoRequest profilePhotoRequest }) async
    test('test yes4trackV1UsersIdPhotoPut', () async {
      // TODO
    });
    ...
    // User SignIn
    //
    //Future<PostUserSignInResponse> yes4trackV1UsersSigninPost({ String xApiKey, String xCsrfToken, PostUserSignInRequest postUserSignInRequest }) async
