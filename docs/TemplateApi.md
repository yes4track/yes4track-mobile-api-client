 ...
 **xCsrfToken** | **String**| CSRF Protection | [optional] [default to cd0f991c-f24b-408d-b88b-1435e080b915]
 ...
 **xApiKey** | **String**| Your Api Key | [optional] 
 **xCsrfToken** | **String**| CSRF Protection | [optional] [default to 82bfa7e3-afc2-454f-a8f8-0af41e6df5d0]
 ...
 **id** | [**String**](.md)| Template id | 
 **xApiKey** | **String**| Your Api Key | [optional] 
 **xCsrfToken** | **String**| CSRF Protection | [optional] [default to 533629dc-e6e5-4c22-ae73-0e40920ef028]
...
> yes4trackV1TemplatesIdPatch(body, id, xApiKey, xCsrfToken)
...
try {
    api_instance.yes4trackV1TemplatesIdPatch(body, id, xApiKey, xCsrfToken);
} catch (e) {
 ...
 **id** | [**String**](.md)| Template id | 
 **xApiKey** | **String**| Your Api Key | [optional] 
 **xCsrfToken** | **String**| CSRF Protection | [optional] [default to 8fb13907-0bea-4132-b0fe-ef371a309db3]
...
> List<String> yes4trackV1TemplatesIdPhotosUploadPost(id, xApiKey, xCsrfToken)
 ...
 **id** | [**String**](.md)| Template Id | 
 **xApiKey** | **String**| Your Api Key | [optional] 
 **xCsrfToken** | **String**| CSRF Protection | [optional] [default to 46a648ea-1892-4a8c-8224-83297f227ff2]
...
> yes4trackV1TemplatesIdPut(id, body, xApiKey, xCsrfToken)
...
var api_instance = new TemplateApi();
var id = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | Template Id
var body = new PutTemplateRequest(); // PutTemplateRequest | Template to update
var xApiKey = xApiKey_example; // String | Your Api Key
var xCsrfToken = xCsrfToken_example; // String | CSRF Protection

try {
    api_instance.yes4trackV1TemplatesIdPut(id, body, xApiKey, xCsrfToken);
} catch (e) {
 ...
 **xApiKey** | **String**| Your Api Key | [optional] 
 **xCsrfToken** | **String**| CSRF Protection | [optional] [default to 0b646d3e-c6c6-4c64-908e-99250ff747fd]
...
> PostTemplateResponse yes4trackV1TemplatesPost(body, xApiKey, xCsrfToken)
...
var api_instance = new TemplateApi();
var body = new PostTemplateRequest(); // PostTemplateRequest | Template to create
var xApiKey = xApiKey_example; // String | Your Api Key
var xCsrfToken = xCsrfToken_example; // String | CSRF Protection

try {
    var result = api_instance.yes4trackV1TemplatesPost(body, xApiKey, xCsrfToken);
    print(result);
} catch (e) {
 ...
 **xApiKey** | **String**| Your Api Key | [optional] 
 **xCsrfToken** | **String**| CSRF Protection | [optional] [default to 47520757-c597-41ab-b7bf-a1e1703fde92]
