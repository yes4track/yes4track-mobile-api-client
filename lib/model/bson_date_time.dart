...
class BsonDateTime {
  ...
  int millisecondsSinceEpoch = null;
  ...
  static List<BsonDateTime> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<BsonDateTime>()
        : json.map((value) => new BsonDateTime.fromJson(value)).toList();
  }

  static Map<String, BsonDateTime> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonDateTime>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new BsonDateTime.fromJson(value));
    }
    return map;
  }
}
