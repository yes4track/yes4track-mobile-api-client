...
class BsonUndefined {
  ...
  static List<BsonUndefined> listFromJson(List<dynamic> json) {
    return json == null ? new List<BsonUndefined>() : json.map((value) => new BsonUndefined.fromJson(value)).toList();
  }

  static Map<String, BsonUndefined> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonUndefined>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new BsonUndefined.fromJson(value));
    }
    return map;
  }
}
