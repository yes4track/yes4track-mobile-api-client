...
class BsonJavaScriptWithScope {
  ...
  BsonJavaScriptWithScope.fromJson(Map<String, dynamic> json) {
    ...
    asBsonJavaScriptWithScope = new BsonJavaScriptWithScope.fromJson(json['asBsonJavaScriptWithScope']);
    ...
    asBsonRegularExpression = new BsonRegularExpression.fromJson(json['asBsonRegularExpression']);
    ...
    asDateTime = json['asDateTime'] == null ? null : DateTime.parse(json['asDateTime']);
    asDecimal = json['asDecimal'];
    asDecimal128 = new Decimal128.fromJson(json['asDecimal128']);
    asDouble = json['asDouble'];
    asGuid = json['asGuid'];
    asInt32 = json['asInt32'];
    asLocalTime = json['asLocalTime'] == null ? null : DateTime.parse(json['asLocalTime']);
    asInt64 = json['asInt64'];
    asNullableBoolean = json['asNullableBoolean'];
    asNullableDateTime = json['asNullableDateTime'] == null ? null : DateTime.parse(json['asNullableDateTime']);
    asNullableDecimal = json['asNullableDecimal'];
    asNullableDecimal128 = new Decimal128.fromJson(json['asNullableDecimal128']);
    ...
    asUniversalTime = json['asUniversalTime'] == null ? null : DateTime.parse(json['asUniversalTime']);
    ...
    scope = BsonElement.listFromJson(json['scope']);
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'asDateTime': asDateTime == null ? '' : asDateTime.toUtc().toIso8601String(),
      'asDecimal': asDecimal,
      'asDecimal128': asDecimal128,
      'asDouble': asDouble,
      'asGuid': asGuid,
      'asInt32': asInt32,
      'asLocalTime': asLocalTime == null ? '' : asLocalTime.toUtc().toIso8601String(),
      'asInt64': asInt64,
      'asNullableBoolean': asNullableBoolean,
      'asNullableDateTime': asNullableDateTime == null ? '' : asNullableDateTime.toUtc().toIso8601String(),
      ...
      'asRegex': asRegex,
      'asString': asString,
      'asUniversalTime': asUniversalTime == null ? '' : asUniversalTime.toUtc().toIso8601String(),
      'isBoolean': isBoolean,
  ...
  static List<BsonJavaScriptWithScope> listFromJson(List<dynamic> json) {
    return json == null ? new List<BsonJavaScriptWithScope>() : json.map((value) => new BsonJavaScriptWithScope.fromJson(value)).toList();
  }

  static Map<String, BsonJavaScriptWithScope> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonJavaScriptWithScope>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new BsonJavaScriptWithScope.fromJson(value));
    }
    return map;
  }
}
