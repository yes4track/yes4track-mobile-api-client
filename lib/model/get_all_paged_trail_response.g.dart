...
Serializer<GetAllPagedTrailResponse> _$getAllPagedTrailResponseSerializer =
    new _$GetAllPagedTrailResponseSerializer();

class _$GetAllPagedTrailResponseSerializer
    implements StructuredSerializer<GetAllPagedTrailResponse> {
  @override
  final Iterable<Type> types = const [
    GetAllPagedTrailResponse,
    _$GetAllPagedTrailResponse
  ];
  @override
  final String wireName = 'GetAllPagedTrailResponse';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GetAllPagedTrailResponse object,
  ...
  @override
  GetAllPagedTrailResponse deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GetAllPagedTrailResponseBuilder();
