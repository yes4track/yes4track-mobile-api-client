...
Serializer<PostCompanyResponse> _$postCompanyResponseSerializer =
    new _$PostCompanyResponseSerializer();

class _$PostCompanyResponseSerializer
    implements StructuredSerializer<PostCompanyResponse> {
  @override
  final Iterable<Type> types = const [
    PostCompanyResponse,
    _$PostCompanyResponse
  ];
  @override
  final String wireName = 'PostCompanyResponse';

  @override
  Iterable<Object> serialize(
      Serializers serializers, PostCompanyResponse object,
  ...
  @override
  PostCompanyResponse deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PostCompanyResponseBuilder();
