...
Serializer<PostAdventureRequest> _$postAdventureRequestSerializer =
    new _$PostAdventureRequestSerializer();

class _$PostAdventureRequestSerializer
    implements StructuredSerializer<PostAdventureRequest> {
  @override
  final Iterable<Type> types = const [
    PostAdventureRequest,
    _$PostAdventureRequest
  ];
  @override
  final String wireName = 'PostAdventureRequest';

  @override
  Iterable<Object> serialize(
      Serializers serializers, PostAdventureRequest object,
  ...
  @override
  PostAdventureRequest deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PostAdventureRequestBuilder();
