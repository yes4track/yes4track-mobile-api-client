...
class BsonRegularExpression {
  ...
  static List<BsonRegularExpression> listFromJson(List<dynamic> json) {
    return json == null ? new List<BsonRegularExpression>() : json.map((value) => new BsonRegularExpression.fromJson(value)).toList();
  }

  static Map<String, BsonRegularExpression> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonRegularExpression>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new BsonRegularExpression.fromJson(value));
    }
    return map;
  }
}
