...
class BsonMinKey {
  ...
  static List<BsonMinKey> listFromJson(List<dynamic> json) {
    return json == null ? new List<BsonMinKey>() : json.map((value) => new BsonMinKey.fromJson(value)).toList();
  }

  static Map<String, BsonMinKey> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonMinKey>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new BsonMinKey.fromJson(value));
    }
    return map;
  }
}
