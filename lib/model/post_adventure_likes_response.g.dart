...
Serializer<PostAdventureLikesResponse> _$postAdventureLikesResponseSerializer =
    new _$PostAdventureLikesResponseSerializer();

class _$PostAdventureLikesResponseSerializer
    implements StructuredSerializer<PostAdventureLikesResponse> {
  @override
  final Iterable<Type> types = const [
    PostAdventureLikesResponse,
    _$PostAdventureLikesResponse
  ];
  @override
  final String wireName = 'PostAdventureLikesResponse';

  @override
  Iterable<Object> serialize(
      Serializers serializers, PostAdventureLikesResponse object,
  ...
  @override
  PostAdventureLikesResponse deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PostAdventureLikesResponseBuilder();
