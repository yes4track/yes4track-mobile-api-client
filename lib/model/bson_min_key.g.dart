...
part of 'bson_min_key.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<BsonMinKey> _$bsonMinKeySerializer = new _$BsonMinKeySerializer();

class _$BsonMinKeySerializer implements StructuredSerializer<BsonMinKey> {
  @override
  final Iterable<Type> types = const [BsonMinKey, _$BsonMinKey];
  @override
  final String wireName = 'BsonMinKey';

  @override
  Iterable<Object> serialize(Serializers serializers, BsonMinKey object,
  ...
  @override
  BsonMinKey deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new BsonMinKeyBuilder();
...
class _$BsonMinKey extends BsonMinKey {
  @override
  ...
  factory _$BsonMinKey([void Function(BsonMinKeyBuilder) updates]) =>
      (new BsonMinKeyBuilder()..update(updates)).build();
  ...
  @override
  BsonMinKey rebuild(void Function(BsonMinKeyBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BsonMinKeyBuilder toBuilder() => new BsonMinKeyBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BsonMinKey &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('BsonMinKey')
...
class BsonMinKeyBuilder implements Builder<BsonMinKey, BsonMinKeyBuilder> {
  _$BsonMinKey _$v;
  ...
  BsonMinKeyBuilder() {
    BsonMinKey._initializeBuilder(this);
  }

  BsonMinKeyBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(BsonMinKey other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$BsonMinKey;
  }

  @override
  void update(void Function(BsonMinKeyBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$BsonMinKey build() {
    _$BsonMinKey _$result;
    try {
      _$result = _$v ??
          new _$BsonMinKey._(
              asBoolean: asBoolean,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'BsonMinKey', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
