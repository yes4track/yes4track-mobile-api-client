...
class BsonTimestamp {
  ...
  static List<BsonTimestamp> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<BsonTimestamp>()
        : json.map((value) => new BsonTimestamp.fromJson(value)).toList();
  }

  static Map<String, BsonTimestamp> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonTimestamp>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new BsonTimestamp.fromJson(value));
    }
    return map;
  }
}
