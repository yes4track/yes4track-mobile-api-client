...
class BsonNull {
  ...
  static List<BsonNull> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<BsonNull>()
        : json.map((value) => new BsonNull.fromJson(value)).toList();
  }

  static Map<String, BsonNull> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonNull>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new BsonNull.fromJson(value));
    }
    return map;
  }
}
