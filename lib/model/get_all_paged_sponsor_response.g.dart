...
Serializer<GetAllPagedSponsorResponse> _$getAllPagedSponsorResponseSerializer =
    new _$GetAllPagedSponsorResponseSerializer();

class _$GetAllPagedSponsorResponseSerializer
    implements StructuredSerializer<GetAllPagedSponsorResponse> {
  @override
  final Iterable<Type> types = const [
    GetAllPagedSponsorResponse,
    _$GetAllPagedSponsorResponse
  ];
  @override
  final String wireName = 'GetAllPagedSponsorResponse';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GetAllPagedSponsorResponse object,
  ...
  @override
  GetAllPagedSponsorResponse deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GetAllPagedSponsorResponseBuilder();
