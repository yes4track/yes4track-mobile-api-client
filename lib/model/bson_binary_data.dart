...
class BsonBinaryData {
  ...
  GuidRepresentation guidRepresentation = null;
  ...
  BsonBinaryData.fromJson(Map<String, dynamic> json) {
    ...
    bytes = json['bytes'];
    guidRepresentation =
        new GuidRepresentation.fromJson(json['guidRepresentation']);
    //rawValue = new Object.fromJson(json['rawValue']);
    subType = new BsonBinarySubType.fromJson(json['subType']);
  }
  ...
  static List<BsonBinaryData> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<BsonBinaryData>()
        : json.map((value) => new BsonBinaryData.fromJson(value)).toList();
  }

  static Map<String, BsonBinaryData> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonBinaryData>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new BsonBinaryData.fromJson(value));
    }
    return map;
  }
}
