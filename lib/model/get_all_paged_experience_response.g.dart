...
Serializer<GetAllPagedExperienceResponse>
    _$getAllPagedExperienceResponseSerializer =
    new _$GetAllPagedExperienceResponseSerializer();

class _$GetAllPagedExperienceResponseSerializer
    implements StructuredSerializer<GetAllPagedExperienceResponse> {
  @override
  final Iterable<Type> types = const [
    GetAllPagedExperienceResponse,
    _$GetAllPagedExperienceResponse
  ];
  @override
  final String wireName = 'GetAllPagedExperienceResponse';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GetAllPagedExperienceResponse object,
  ...
  @override
  GetAllPagedExperienceResponse deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GetAllPagedExperienceResponseBuilder();
        ...
        case 'results':
          result.results.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [
                const FullType(GetAllExperienceResponse)
              ])) as BuiltList<Object>);
          break;
      }
    }
