...
Serializer<GetAllPagedTemplateResponse>
    _$getAllPagedTemplateResponseSerializer =
    new _$GetAllPagedTemplateResponseSerializer();

class _$GetAllPagedTemplateResponseSerializer
    implements StructuredSerializer<GetAllPagedTemplateResponse> {
  @override
  final Iterable<Type> types = const [
    GetAllPagedTemplateResponse,
    _$GetAllPagedTemplateResponse
  ];
  @override
  final String wireName = 'GetAllPagedTemplateResponse';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GetAllPagedTemplateResponse object,
  ...
  @override
  GetAllPagedTemplateResponse deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GetAllPagedTemplateResponseBuilder();
        ...
        case 'results':
          result.results.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [
                const FullType(GetAllTemplateResponse)
              ])) as BuiltList<Object>);
          break;
      }
    }
...
class _$GetAllPagedTemplateResponse extends GetAllPagedTemplateResponse {
  ...
  factory _$GetAllPagedTemplateResponse(
      ...
      (new GetAllPagedTemplateResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllPagedTemplateResponse')
...
class GetAllPagedTemplateResponseBuilder
  ...
  @override
  _$GetAllPagedTemplateResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetAllPagedTemplateResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
