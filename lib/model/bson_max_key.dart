...
class BsonMaxKey {
  ...
  static List<BsonMaxKey> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<BsonMaxKey>()
        : json.map((value) => new BsonMaxKey.fromJson(value)).toList();
  }

  static Map<String, BsonMaxKey> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonMaxKey>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new BsonMaxKey.fromJson(value));
    }
    return map;
  }
}
