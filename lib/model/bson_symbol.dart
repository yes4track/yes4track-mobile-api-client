...
class BsonSymbol {
  ...
  static List<BsonSymbol> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<BsonSymbol>()
        : json.map((value) => new BsonSymbol.fromJson(value)).toList();
  }

  static Map<String, BsonSymbol> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, BsonSymbol>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new BsonSymbol.fromJson(value));
    }
    return map;
  }
}
