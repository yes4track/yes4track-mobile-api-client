...
Serializer<PutSponsorRequest> _$putSponsorRequestSerializer =
    new _$PutSponsorRequestSerializer();

class _$PutSponsorRequestSerializer
    implements StructuredSerializer<PutSponsorRequest> {
  @override
  final Iterable<Type> types = const [PutSponsorRequest, _$PutSponsorRequest];
  @override
  final String wireName = 'PutSponsorRequest';
  ...
  @override
  PutSponsorRequest deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PutSponsorRequestBuilder();
