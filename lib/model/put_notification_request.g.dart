...
Serializer<PutNotificationRequest> _$putNotificationRequestSerializer =
    new _$PutNotificationRequestSerializer();

class _$PutNotificationRequestSerializer
    implements StructuredSerializer<PutNotificationRequest> {
  @override
  final Iterable<Type> types = const [
    PutNotificationRequest,
    _$PutNotificationRequest
  ];
  @override
  final String wireName = 'PutNotificationRequest';

  @override
  Iterable<Object> serialize(
      Serializers serializers, PutNotificationRequest object,
  ...
  PutNotificationRequest deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PutNotificationRequestBuilder();
