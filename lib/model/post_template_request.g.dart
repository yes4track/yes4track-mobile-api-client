...
Serializer<PostTemplateRequest> _$postTemplateRequestSerializer =
    new _$PostTemplateRequestSerializer();

class _$PostTemplateRequestSerializer
    implements StructuredSerializer<PostTemplateRequest> {
  @override
  final Iterable<Type> types = const [
    PostTemplateRequest,
    _$PostTemplateRequest
  ];
  @override
  final String wireName = 'PostTemplateRequest';

  @override
  Iterable<Object> serialize(
      Serializers serializers, PostTemplateRequest object,
  ...
  @override
  PostTemplateRequest deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PostTemplateRequestBuilder();
