...
class CompanyApi {
  ...
  Future<GetAllCompanyResponse> getByIdCompany(String id, { String xApiKey, String xCsrfToken }) async {
    ...
    String path = "/yes4track/v1/companies/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetAllCompanyResponse') as GetAllCompanyResponse ;
    } else {
      return null;
    }
  }
  ...
  Future<GetAllPagedCompanyResponse> yes4trackV1CompaniesGet({ String legalName, String fantasyName, String registrationNumber, String contactEmail, int page, int pageSize, String sort, String xApiKey, String xCsrfToken }) async {
    ...
    // create path and map variables
    String path = "/yes4track/v1/companies".replaceAll("{format}","json");
    ...
    Map<String, String> formParams = {};
    if(legalName != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "legalName", legalName));
    }
    if(fantasyName != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "fantasyName", fantasyName));
    }
    if(registrationNumber != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "registrationNumber", registrationNumber));
    }
    if(contactEmail != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "contactEmail", contactEmail));
    }
    if(page != null) {
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetAllPagedCompanyResponse') as GetAllPagedCompanyResponse ;
    } else {
      return null;
    }
  }
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'PostCompanyResponse') as PostCompanyResponse ;
    } else {
      return null;
    }
  }
