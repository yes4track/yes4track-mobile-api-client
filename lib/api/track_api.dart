...
class TrackApi {
  ...
  TrackApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<GetAllTrackResponse> getByIdTrack(String id, { String xApiKey, String xCsrfToken }) async {
    ...
    String path = "/yes4track/v1/tracks/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetAllTrackResponse') as GetAllTrackResponse ;
    } else {
      return null;
    }
  }
  ...
  Future getByIdTrackGeoData(String id, { String xApiKey, String xCsrfToken }) async {
    ...
    // create path and map variables
    String path = "/yes4track/v1/tracks/{id}/geodata".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
...
headerParams["x-csrf-token"] = xCsrfToken;
  ...
  Future<GetAllPagedTrackResponse> yes4trackV1TracksGet(String adventureId, { String name, TrackSource source, int page, int pageSize, String sort, String xApiKey, String xCsrfToken }) async {
    ...
    // verify required params are set
    if(adventureId == null) {
     throw new ApiException(400, "Missing required param: adventureId");
    }

    // create path and map variables
    String path = "/yes4track/v1/tracks".replaceAll("{format}","json");
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetAllPagedTrackResponse') as GetAllPagedTrackResponse ;
    } else {
      return null;
    }
  }
...
headerParams["x-csrf-token"] = xCsrfToken;
  ...
  Future yes4trackV1TracksIdEstatisticPut(String id, { PutTrackEstatisticRequest body, String xApiKey, String xCsrfToken }) async {
    ...
    // create path and map variables
    String path = "/yes4track/v1/tracks/{id}/estatistic".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'PostTrackGeoDataResponse') as PostTrackGeoDataResponse ;
    } else {
      return null;
    }
  }
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'PostTrackResponse') as PostTrackResponse ;
    } else {
      return null;
    }
  }
