...
class TemplateApi {
  ...
  Future<GetAllTemplateResponse> getByIdTemplate(String id, { String xApiKey, String xCsrfToken }) async {
    ...
    String path = "/yes4track/v1/templates/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetAllTemplateResponse') as GetAllTemplateResponse ;
    } else {
      return null;
    }
  }
  ...
  Future<GetAllPagedTemplateResponse> yes4trackV1TemplatesGet({ String name, int page, int pageSize, String sort, String xApiKey, String xCsrfToken }) async {
    ...
    // create path and map variables
    String path = "/yes4track/v1/templates".replaceAll("{format}","json");
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetAllPagedTemplateResponse') as GetAllPagedTemplateResponse ;
    } else {
      return null;
    }
  }
...
headerParams["x-csrf-token"] = xCsrfToken;
  ...
  Future<List<String>> yes4trackV1TemplatesIdPhotosUploadPost(String id, { String xApiKey, String xCsrfToken }) async {
    ...
    // create path and map variables
    String path = "/yes4track/v1/templates/{id}/photos/upload".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
...
headerParams["x-csrf-token"] = xCsrfToken;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'PostTemplateResponse') as PostTemplateResponse ;
    } else {
      return null;
    }
  }
