...
void main() {
  ...
  group(TrailApi, () {
    ...
    //
    //Future<BuiltList<GetAllActiveTrailByAngelResponse>> yes4trackV1TrailsActiveByAngelGet({ String xApiKey, String xCsrfToken }) async
    ...
    //
    //Future<PostTrailGeoDataResponse> yes4trackV1TrailsIdGeodataChunckPost(String id, PostTrailChunckGeoDataRequest postTrailChunckGeoDataRequest, { String xApiKey, String xCsrfToken }) async
